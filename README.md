...
Team project for **Machine Learning, Semester 2026-III** — Computer Engineering,
Universidad Distrital Francisco José de Caldas. Instructor: Eng. Carlos Andrés Sierra, M.Sc.

**Team 4 — Sentiment Analysis (NLP):** Xiomara Salome Arias Arias, Julian David Celis
Giraldo, Alejandro Gomez Moyano.

The assignment (`TeamsDistribution.pdf`) runs six workshops over one problem domain. Ours
is sentiment analysis on a corpus of **42,656 Disneyland park reviews**, each with a 1-5
